                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <hr class="card-header">
                            ...
                            <hr><i class="fa fa-tag">标题${article.name}</i></hr>
                            <div class="pull-right">
                                <i class="fa fa-edit">发布时间<%=nowDate%></i>
                                <i class="fa fa-user">文章作者${article.author}</i>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        <div class="pull-left">
                            <a href="#"><i class="fa fa-arrow-left">上一篇</i></a>

                        </div>

                        <div class="pull-right">
                            <a href="#"> <i class="fa fa-arrow-right">下一篇</i></a>
                        </div>
                    </div>
