            ...
            <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <a href="${pageContext.request.contextPath}/formList.do">
                            <i class="fa fa-list"></i> 返回表单列表
                        </a>
                    </div>
                    <div class="card-body">
                            <form method="post" action="${pageContext.request.contextPath}/eleAdd.do"
                                  enctype="multipart/form-data">
                                命名:<input type="text" name="name"><br>
                                所属表单<input type="text" name="formname" value="${forms.name}" readonly><br>
