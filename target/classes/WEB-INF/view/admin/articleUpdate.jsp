        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form method="post" action="${pageContext.request.contextPath}/articleUpdate.do">
                        <hr class="card-header">
                            文章编号 <input type="text" readonly name="id" value="${article.id}" style="color:black"><br>
                            文章标题 <input type="text" name="name" value="${article.name}"><br>
...
<script>
    ...
    function getArticleContent() {
        ...
        $.ajax({
            url:'http://localhost:8080/articleUpdate.do',
            type:'POST',
            data:{
                name:name,
                content:content
