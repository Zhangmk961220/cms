            ...
            <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <a href="${pageContext.request.contextPath}/articleList.do">
                        <i class="fa fa-list"></i> 返回文章列表
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="card-header">
                            <i class="fa fa-tag">标题</i>
                            <input class="nav-link-text" id="title" placeholder="输入文章标题"/>
                            <div class="pull-right">
                                    <i class="fa fa-edit">发布时间</i>
                                <input type="text" id="edit_date" value="<%=nowDate%>" readonly="readonly"/>

                                <i class="fa fa-user">文章作者</i>
                                <input type="text" id="author" value="${sessionScope.name}" readonly="readonly"/>
                            </div>
                        </div>
                        ...
                        <button class="btn-dark pull-right" onclick="getArticleContent()"> <i class="fa fa-send">提交</i></button>
                    </div>
                    <div class="card-footer small text-muted">Updated time<%=nowDate%></div>
                </div>
...
<script>
    ...
    function getArticleContent() {
        ...
        // var editTime=$('#edit_date').attr('value');
        // console.log(editTime);


        $.ajax({
            url:'http://localhost:8080/articleAdd.do',
            type:'POST',
            data:{
                name:name,
                content:content
            ...
            success:function(data) {
                //跳转到文章详细页面
                window.location.href = "/article_info.do?id=" + data;
            },
            error:function () {
                alert("操作失败 请重新发送");
            }
