            ...
            <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <a href="${pageContext.request.contextPath}/queryMediaList.do">
                        <i class="fa fa-list"></i> 返回媒体库列表
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <%--<form method="post" action="${pageContext.request.contextPath}/mediaAdd.do"--%>
                            ...
                            <%--<i class="fa fa-tag"> 媒体库名称：</i><input type="text" name="name"><br>--%>
                            <%--<i class="fa fa-sort"> 媒体库类别：</i> <br>--%>
                            <%--<div>--%>
                            ...
                            <%--&lt;%&ndash;媒体库所属栏目：<input type="text" name="categoryId"><br>&ndash;%&gt;--%>
